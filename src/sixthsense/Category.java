	       ...
	       public Gesture getGesture (int i)
	        ...
	        public void AddExample(Gesture p)
	        {
	            ...
	            try
	            {
	                ...
	                if (name != _name)
	                    throw new Exception("Prototype name does not equal the name of the category to which it was added.");
	                ...
	                for (int i = 0; i < _prototypes.size(); i++)
	                {
	                    ...
	                    if (p0.Name == p.Name)
	                        throw new Exception("Prototype name was added more than once to its category.");
	                }
	            }
	            catch (Exception ex)
	            {
